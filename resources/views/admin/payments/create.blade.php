    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form action="{{ route('admin.payments.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="tenant_id" required class="form-select w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500">
            ...
            <div>
                ...
                <input type="month" name="month" required value="{{ date('Y-m') }}" class="form-input w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500">
            </div>
            ...
            <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="from_unit" required min="0" class="form-input w-full rounded-lg border-gray-300">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-500 mb-1">Current Unit</label>
                        <input type="number" name="to_unit" required min="0" class="form-input w-full rounded-lg border-gray-300">
                    </div>
                    <div class="col-span-2">
                        <label class="block text-xs font-semibold text-gray-500 mb-1">Cost Per Unit</label>
                        <input type="number" name="eb_rate" required value="10" step="0.01" class="form-input w-full rounded-lg border-gray-300">
                    </div>
                </div>
            </div>
